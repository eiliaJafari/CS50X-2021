...
bool print_winner(void)
{
    // The winner should have more than half of total votes
...
int find_min(void)
{
    ...
    for (int i = 0; i < candidate_count; i++)
    {
        ...
        {
            // Updating the number of min vote
...
bool is_tie(int min)
{
    for (int i = 0; i < candidate_count; i++)
    {
        ...
        {
            // If the election isn't tied
            return false;
        }
    }

    // If the election is tied
    return true;
}
